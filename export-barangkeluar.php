...
<!DOCTYPE html5>
<head>
    <title id="stock-title">Barang Keluar</title>
    <script>
        var today = new Date();
        ...
        title.innerHTML = "Barang Keluar (" + year + "-" + month + "-" + date + ")";
    </script>
...
<body>
    <div class="container">
        ...
        <div class="data-tables datatable-dark">
            <table class="table table-bordered" id="data-table-barangkeluar" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th>Tanggal</th>
                        <th>ID Barang</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#data-table-barangkeluar').DataTable({
                fixedHeader: {
                    header: true,
                    footer: true
                },
