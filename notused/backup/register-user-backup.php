...
// Registrasi
    ...
    if (isset($_POST['register'])) {
        ...
        $insert = mysqli_query($conn, "INSERT INTO userlogin (email, password) VALUES ('$email', '$password')");
        if ($insert) {
...
<head>
    ...
    <title>Registration User - Stock.U Aplikasi Stock Barang</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            <div class="card-header"><h3 class="text-center font-weight-light my-4">Registration User</h3></div>
                            <a class="card-logo">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                        ...
                                        <!-- <button class="btn btn-link" onclick="history.back()">Already have an account? Log in!</button> -->
                                    </div>
                                </form>
                            </div>
                            <div class="card-footer text-center">
                                        <div class="small"><a href="login-user.php">Need an account? Sign up!</a></div>
                                    </div>
                        </div>
                    </div>
                </div>
