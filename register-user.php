...
if (isset($_POST['register'])) {
    ...
    try {
        ...
        if ($e->getCode() === 1062) {
            $registration_status = "Email sudah digunakan, silakan coba email lain.";
        } else {
            $registration_status = "Terjadi kesalahan: " . $e->getMessage();
        }
    }
}
?>
...
<head>
    ...
    <title>Registration User - Yuk Ngestok Membantu Bisnis Anda Lebih Mudah</title>
                    ...
                    <div class="col-lg-5">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            <div class="card-header">
                                <h3 class="text-center font-weight-light my-4">Registration User</h3>
                            </div>
                            <a class="card-logo">
                            ...
                            <div class="card-footer text-center">
                                <div class="small"><a href="login-user.php">Sudah punya akun User? Ayo login sekarang!</a></div>
                            </div>
                        </div>
                    </div>
                </div>
